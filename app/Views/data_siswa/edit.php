<div id="main-content">
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <form action="<?= base_url('data_master/aksi_edit_siswa/')?>" method="post" class="row g-3"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="custom-file">
                                    <div class="col-12 col-md-12">
                                        <input type="file" class="logo-perusahaan" id="foto" name="foto"
                                            accept="image/*">
                                    </div>
                                </div>
                            </div>
                            <div id="preview">
                                <?php if ($rizkan->foto): ?>
                                <img src="<?=base_url('images/'. $rizkan->foto)?>" class="img-fluid rounded"
                                    width="100px">
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_guru" class="form-control" name="nama"
                                        placeholder="Nama Siswa" value="<?php echo $jojo->nama_siswa?>" />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
