        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url('/data_master/tambah_tahun/')?>">
                ...
                foreach ($a as $b) {
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url('/data_master/edit_tahun/'.$b->id_tahun)?>"><button
                                                class="btn btn-primary">Edit</button></a>
                                        <a href="<?=base_url('/data_master/delete_tahun/'.$b->id_tahun)?>"><button
                                                class="btn btn-danger">Delete</button></a>
                                        <form method="post" action="<?= base_url('/data_master/aksi/'.$b->id_tahun) ?>">
