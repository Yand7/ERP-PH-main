            ...
            <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                    <li class="submenu-item">
                        <a href="<?= base_url('/Ruangan/jenjang') ?>" class="submenu-link">Jenjang</a>
                    </li>
                    <li class="submenu-item">
                        <a href="<?= base_url('/Ruangan') ?>" class="submenu-link">Kelas</a>
                    </li>

                    <li class="submenu-item">
                        <a href="<?= base_url('/Ruangan/jurusan') ?>" class="submenu-link">Jurusan</a>
                    </li>

                    <li class="submenu-item">
                        <a href="<?= base_url('/Ruangan/rombel') ?>" class="submenu-link">Rombel</a>
                    </li>
                </ul>
            </li>
...
<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li
            class="sidebar-item <?php if($uri->getSegment(1) == "data_absensi_guru" && $uri->getSegment(2) !== "menu_print") {echo "active";}?>">
...
<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li
            class="sidebar-item <?php if($uri->getSegment(1) == "data_absensi_sekretaris" && $uri->getSegment(2) !== "menu_print") {echo "active";}?>">
