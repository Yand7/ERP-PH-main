        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url('/data_master/tambah_mapel/')?>">
                ...
                foreach ($a as $b) {
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url('/data_master/edit_mapel/'.$b->id_mapel)?>"><button
                                                class="btn btn-primary">Edit</button></a>
                                        <a href="<?=base_url('/data_master/delete_mapel/'.$b->id_mapel)?>"><button
