...
<div id="auth">
	<div class="row h-100">
		<div class="col-lg-5 col-12">
			<div id="auth-left">
				<div class="auth-logo">
					<img src="<?=base_url('@agendapkl/assets/compiled/svg/logo.svg')?>" alt="Logo">
				</div>
				...
				<form action="<?= base_url('agendapkl/login/aksi_login/')?>"method="post">
		...
		<div class="col-lg-7 d-none d-lg-block">
			...
			<!-- <img src="<?= base_url('agendapkl/images/background.jpg') ?>" width="150%" alt="Background Image" style="height: 80%; background: linear-gradient(90deg, #2d499d, #3f5491);"> -->
		</div>
	</div>
</div>
</body>
