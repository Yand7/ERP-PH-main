				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="mb-3">
								<label for="namasiswa" class="form-label">Kajur</label>
								<select class="form-select" id="kajur" placeholder="Masukkan Kajur" name="kajur" value="<?php echo $jojo->kajur ?>" required>
									<option value="<?php echo $jojo->kajur ?>">- Pilih -</option>
									<?php 
									foreach ($kajur as $ketuajurusan) {
										?>
										<option value="<?=$ketuajurusan->user_guru?>"><?= $ketuajurusan->nama_guru?></option>
									<?php } ?>
								</select>
							</div>
							<!-- form bagian kanan -->
