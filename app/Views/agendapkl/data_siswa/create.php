<div id="main-content">
	...
	<section class="section">
		<div class="card">
			<form action="<?= base_url('agendapkl/data_siswa/aksi_create/')?>" method="post" class="row g-3" enctype="multipart/form-data">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-6 col-md-12">	
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="nis" placeholder="Masukkan NIK (Max 10 Digit)" name="nis" required>
							</div>
							<div class="mb-3">
						...
						<div class="col-md-6">
							...
							<div class="mb-3">
								...
								<select class="form-select" id="kajur" placeholder="Masukkan Kajur" name="kajur" required>
									<option value="">- Pilih -</option>
									<?php 
