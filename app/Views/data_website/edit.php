<div id="main-content">
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <form action="<?= base_url('data_master/aksi_edit_website/')?>" method="post" class="row g-3"
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <div class="custom-file">
                                            <div class="col-12 col-md-12">
                                                <input type="file" class="logo-perusahaan" id="logo_website"
                                                    name="logo_website" accept="image/*" onchange="previewImage()">
                                            </div>
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_website"
                                        placeholder="Masukkan Nama Website" name="nama_website"
                                        value="<?php echo $jojo->nama_website ?>" required>
                                </div>
                            </div>
                        </div>
