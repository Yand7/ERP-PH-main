        ...
        <div class="page-content">
            ...
            <div class="card">
              ...
              if ($level == 1 || $level == 2 || $level == 3) {
                ...
                echo "<h5 class='font-bold'>Selamat Datang, " . session()->get('username') . " di Data Master</h5>";
              } elseif ($level == 4 || $level == 5) {
                    // Jika level 4 atau 5, gunakan $siswa->nama_siswa
                echo "<h5 class='font-bold'>Selamat Datang, $siswa->nama_siswa di Data Master</h5>";
              } else {
                    // Jika level tidak sesuai dengan kriteria di atas
                echo "<h5 class='font-bold'>Selamat Datang di Data Master</h5>";
              }
              ?>
                        </div>
                    </div>
                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?=base_url('assets/compiled/jpg/building.jpg')?>"
                                                class="d-block w-100" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?=base_url('assets/compiled/jpg/architecture1.jpg')?>"
                                                class="d-block w-100" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?=base_url('/assets/compiled/png/1.png')?>"
                                                class="d-block w-100" />
                                        ...
                                        <div class="carousel-item">
                                            <img src="<?=base_url('/assets/compiled/png/2.png')?>"
                                                class="d-block w-100" />
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5>Aturan #2</h5>
                                        ...
                                        <div class="carousel-item">
                                            <img src="<?=base_url('/assets/compiled/png/3.png')?>"
                                                class="d-block w-100" />
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5>Aturan #3</h5>
