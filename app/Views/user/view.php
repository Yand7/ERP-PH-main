            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=base_url('data_master')?>">Dashboard</a>
                            </li>
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; height: 100px; overflow: hidden; border-radius: 5px;">
                                    <img src="<?php echo base_url('images/' . $riz->foto) ?>"
                                ...
                                <td>
                                    <a class="btn btn-danger"
                                        href="<?php echo base_url('data_master/reset_password/'. $riz->id_user) ?>"><i
                                            class="faj-button fa-solid fa-key"></i>Reset Password</a>
                                </td>
