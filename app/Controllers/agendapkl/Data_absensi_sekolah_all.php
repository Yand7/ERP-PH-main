...
class Data_absensi_sekolah_all extends BaseController
{
    ...
    public function index()
    {
       if(session()->get('level')==4 || session()->get('level')==7) {
        ...
        echo view('agendapkl/data_absensi_sekolah_all/menu', $data);
...
public function rpl()
{
    if(session()->get('level')==4 || session()->get('level')==7) {
        ...
        echo view('agendapkl/partial/side_menu');
        echo view('agendapkl/partial/top_menu');
        echo view('agendapkl/data_absensi_sekolah_all/view', $data);
        echo view('agendapkl/partial/footer_datatable');
    }else {
        return redirect()->to('agendapkl');
    }
...
public function menu_print_rpl()
{
    if(session()->get('level')==7) {
        ...
        echo view('agendapkl/partial/side_menu');
        echo view('agendapkl/partial/top_menu');
        echo view('agendapkl/data_absensi_sekolah_all/menu_print', $data);
        echo view('agendapkl/partial/footer_datatable');    
    }else {
        return redirect()->to('agendapkl');
    }
...
public function export_windows()
{
    if (session()->get('level') == 3) {
        ...
        echo view('agendapkl/partial/header_datatable', $title);
        echo view('agendapkl/data_absensi_sekolah_all/print_windows_view', $data);
        echo view('agendapkl/partial/footer_datatable');  
    } else {
        return redirect()->to('agendapkl');
    }
...
public function export_pdf()
{
    if (session()->get('level') == 3) {
        ...
        $dompdf->loadHtml(view('agendapkl/data_absensi_sekolah_all/print_pdf_view',$data));
