...
use App\Models\agendapkl\M_kesiswaan;
use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
use PhpOffice\PhpSpreadsheet\IOFactory;

class Data_kesiswaan extends BaseController
{
    public function index()
    {
       if(session()->get('level')== 1) {
        $model=new M_kesiswaan();
        $on='data_guru.jabatan=level.id_level';
        $data['jojo']=$model->join2('data_guru', 'level', $on);
        $data['title']='Data Kesiswaan';
        ...
        echo view('agendapkl/data_kesiswaan/view', $data);
...
public function create()
{
    if(session()->get('level')== 1) {
        ...
        echo view('agendapkl/partial/side_menu');
        echo view('agendapkl/partial/top_menu');
        echo view('agendapkl/data_kesiswaan/create', $data); 
        echo view('agendapkl/partial/footer_datatable');
    }else {
        return redirect()->to('agendapkl');
    }
...
{ 
    if(session()->get('level')== 1) {
        ...
        echo view('agendapkl/partial/top_menu');
        echo view('agendapkl/partial/footer_datatable');
        return redirect()->to('agendapkl/data_kesiswaan');
    }else {
        return redirect()->to('agendapkl');
    }
}
...
{ 
    if(session()->get('level')== 1) {
        ...
        echo view('agendapkl/partial/side_menu');
        echo view('agendapkl/partial/top_menu');
        echo view('agendapkl/data_kesiswaan/edit',$data);
        echo view('agendapkl/partial/footer_datatable');    
    }else {
